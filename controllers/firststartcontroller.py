import re
from controllers.logincontroller import Session
...
class FirstStartController:
    ...
    def first_start_controller(self):
        ...
        session = self.username_password_controller()  # L'utilisateur saisi ses identifiants
        ...
        self.database_c.create_databases_controller(session, database_name)  # Création de la bdd
        ...
        self.user_c.start_create_user_controller(session)  # Création de l'utilisateur
    ...
    def username_password_controller(self):
        ...
        return Session(username=result_username, password=result_password, collab_id=None, role_id=None)
